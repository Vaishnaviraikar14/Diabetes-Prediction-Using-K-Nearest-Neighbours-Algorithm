...
def data_file_to_csv():
    #Headers
    headers = ["CodeNumber", "Clump Thickness", "UniformityCellSize", "UniformityCellShape", "MarginalAdhesion", "SingleEpithelialCellSize", "BareNucle", "BlandChromatin", "NormalNucleoli", "Mitoses","CancerType"]
...
###############################################
#Function name: handel missing values
